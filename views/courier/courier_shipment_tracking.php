...
if (isset($_POST['address'])) {
    ...
    if (empty($errors)) {
        ...
        // Input string
        $subjectVal_sender = cdp_getsmsTemplates(4);
        ...
        // Input string
        $subjectVal_receiver = cdp_getsmsTemplates(3);
...
<body>
                                        ...
                                        ?>
                                            <div class="col-sm-12 col-md-6">
                                                ...
                                                <label class="custom-control custom-checkbox" style="font-size: 18px; padding-left: 0px">
                                                    ...
                                                    <b>Notify receiver by SMS <i class="fa fa-envelope" style="font-size: 22px; color:#07bc4c;"></i></b>
                                                    <span class="custom-control-indicator"></span>
                                                </label>
    ...
    <script src="dataJs/courier_tracking.js"></script>
