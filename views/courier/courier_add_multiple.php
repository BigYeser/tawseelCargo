                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div align="">
                                                <a href="shipping_tariffs_add.php" class="btn btn-default mb-2"> <span class="ti-shortcode"></span> Add shipping fee</a>
                                            ...
                                            <table id="insvoice-item-table" class="table">
                                                <tfoot>
                                                    ...
                                                    <tr class="card-hover">
                                                        ...
                                                        <td colspan="1">
                                                            <input type="text" onchange="calculateFinalTotal(this);" onkeypress="return isNumberKey(event)" class="form-control form-control-sm" value="<?php echo $core->value_weight; ?>" name="price_lb" id="price_lb" style="width: 160px;">
                                                        </td>
                                                        <td colspan="2" class="text-right"> <b>Discount % </b></td>
                                                        <td colspan="1" class="text-right">
                                                            <input type="text" onchange="calculateFinalTotal(this);" onkeypress="return isNumberKey(event)" value="0" name="discount_value" id="discount_value" class="form-control form-control-sm">
                                                        </td>
                                                        <td class="text-right">
                                                            <?php
                                                            if ($core->for_symbol !== null) {
                                                    ...
                                                    <tr class="card-hover">
                                                        ...
                                                        <td colspan="1">
                                                            <input type="text" onchange="calculateFinalTotal(this);" onkeypress="return isNumberKey(event)" class="form-control form-control-sm" value="100" name="insured_value" id="insured_value">
                                                        </td>
                                                    ...
                                                    <tr class="card-hover">
                                                        ...
                                                        <td colspan="1" class="text-right">
                                                            <input type="text" onchange="calculateFinalTotal(this);" onkeypress="return isNumberKey(event)" class="form-control form-control-sm" value="<?php echo $core->insurance; ?>" name="insurance_value" id="insurance_value">
                                                        </td>
                                                        <td class="text-right">
                                                            <?php
                                                            if ($core->for_symbol !== null) {
                                                    ...
                                                    <tr class="card-hover">
                                                        ...
                                                        <td colspan="1" class="text-right">
                                                            <input type="text" onchange="calculateFinalTotal(this);" onkeypress="return isNumberKey(event)" class="form-control form-control-sm" value="<?php echo $core->c_tariffs; ?>" name="tariffs_value" id="tariffs_value">
                                                        </td>
                                                        <td class="text-right">
                                                            <?php
                                                            if ($core->for_symbol !== null) {
                                                    ...
                                                    <tr class="card-hover">
                                                        ...
                                                        <td colspan="1">
                                                            <input type="text" onchange="calculateFinalTotal(this);" onkeypress="return isNumberKey(event)" class="form-control form-control-sm" value="<?php echo $core->tax; ?>" name="tax_value" id="tax_value">
                                                        </td>
                                                        <td class="text-right">
                                                            <?php
                                                            if ($core->for_symbol !== null) {
                                                    ...
                                                    <tr class="card-hover">
                                                        ...
                                                        <td colspan="1">
                                                            <input type="text" onchange="calculateFinalTotal(this);" value="<?php echo $core->declared_tax; ?>" onkeypress="return isNumberKey(event)" class="form-control form-control-sm" name="declared_value_tax" id="declared_value_tax">
                                                        </td>
                                                        <td class="text-right">
                                                            <?php
                                                            if ($core->for_symbol !== null) {
                                                    ...
                                                    <tr class="card-hover">
                                                        ...
                                                        <td colspan="1">
                                                            <input type="text" onchange="calculateFinalTotal(this);" onkeypress="return isNumberKey(event)" class="form-control form-control-sm" value="0" name="reexpedicion_value" id="reexpedicion_value">
                                                        </td>
