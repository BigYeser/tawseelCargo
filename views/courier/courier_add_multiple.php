                                            ...
                                            <table id="insvoice-item-table" class="table">
                                                <tfoot>
                                                    ...
                                                    <tr class="card-hover">
                                                        ...
                                                        <td colspan="1">
                                                            <input type="text" onchange="calculateFinalTotal(this);" onkeypress="return isNumberKey(event)" class="form-control form-control-sm" value="0" name="insured_value" id="insured_value">
                                                        </td>
