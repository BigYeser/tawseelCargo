                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" id="save_data" name="save_data" method="post">
                                    ...
                                    <?php echo '<script>console.log("'.$row->state.'");</script>'; ?>
                                    <section>
                                        <div class="row">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select style="width: 100% !important;" class="select2 form-control" name="city_destinycities" id="city_destinycities"><option value="<?php echo $destinycity->id; ?>"><?php echo $destinycity->name; ?></option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
