                    ...
                    <div class="col-lg-12 col-xl-12 col-md-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="d-flex">
                                        <div class="mr-auto">
                                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="btn btn-light active" href="customers_add.php"><i class="ti-plus" aria-hidden="true"></i> <?php echo $lang['edit-clien44'] ?></a>
                                                </li>
                                                &nbsp;&nbsp;
                                                <li class="nav-item">
                                                ...
                                                &nbsp;&nbsp;
                                                <li class="nav-item">
                                                    <a class="btn btn-light btn active" id="pills-profile-tab" href="consolidate_add.php"><i class="fas fas fa-boxes" style="color:#6610f2"></i> <?php echo $lang['conso-lidate'] ?></a>
                                                </li>
                                ...
                                <div class="col-md-6 pull-right m-b-30 m-t-40">

                                    <div class="input-group input-group">
                                        <div class="input-group-append">
                                            <button type="submit" class="btn btn-info"><i class="fa fa-search"></i></button>
                                        </div>
                                        <input type="text" name="search" id="search" class="form-control input-sm float-right" placeholder="search customer" onkeyup="cdp_load(1);">
