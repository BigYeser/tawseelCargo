...
<body>
    ...
    <div id="customer">
        ...
        <table id="meta">
            <tr>
                <td rowspan="5" style="border: 1px solid white; border-right: 1px solid black; text-align: left" width="55%">
                    <strong><?php echo $lang['inv-shipping5'] ?></strong> </br>
                    <table id="items">
                        <b><?php echo $sender_data->fname . " " . $sender_data->lname; ?></b>
                ...
                <td class="meta-head" style="line-height: 7px">
            ...
            <tr>
                <td class="meta-head" style="line-height: 8px">
                    ...
                    <p style="color:white;"><?php echo $lang['add-title22'] ?></p>
                </td>
                <td>
    ...
    <table id="items">
        <tr>
            ...
            <th style="color:white;" width="12%"><b>Weight vol</b></th>
