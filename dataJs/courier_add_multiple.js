...
function loadPackages() {
  ...
  packagesItems.forEach(function (item, index) {
    ...
    html_code += '<div class="col-sm-12 col-md-1">' +
      ...
      '<input type="text" onchange="changePackage(this)" value="' + item.qty + '" onkeypress="return cdp_soloNumeros(event)"  name="qty" id="qty_' + index + '" class="form-control input-sm" data-toggle="tooltip" data-placement="bottom" title="Quantity"  value="1"  />' +
      '</div>' +
      '</div>' +
      '</div>';
    ...
    html_code += '<div class="col-sm-12 col-md-1">' +
      ...
      '<div class="input-group">' +
      '<input type="text" onchange="changePackage(this)" value="' + item.weight + '" onkeypress="return cdp_soloNumeros(event)"  name="weight" id="weight_' + index + '" class="form-control input-sm" data-toggle="tooltip" data-placement="bottom" title="Weight (lb)"/>' +
    ...
    html_code += '<div class="col-sm-12 col-md-1">' +
      ...
      '<div class="input-group">' +
      '<input type="text" onchange="changePackage(this)" value="' + item.length + '" onkeypress="return cdp_soloNumeros(event)" name="length" id="length_' + index + '" class="form-control input-sm text_only" data-toggle="tooltip" data-placement="bottom" title="Length (cm)"/>' +
      '</div>' +
      '</div>' +
      '</div>';
    html_code += '<div class="col-sm-12 col-md-1">' +
      ...
      '<div class="input-group">' +
      '<input type="text" onchange="changePackage(this)" value="' + item.width + '" onkeypress="return cdp_soloNumeros(event)" name="width" id="width_' + index + '" class="form-control input-sm text_only" data-toggle="tooltip" data-placement="bottom" title="Width (cm)"/>' +
    ...
    html_code += '<div class="col-sm-12 col-md-1">' +
      ...
      '<div class="input-group">' +
      '<input type="text" onchange="changePackage(this)" value="' + item.height + '" onkeypress="return cdp_soloNumeros(event)"  name="height" id="height_' + index + '" class="form-control input-sm number_only" data-toggle="tooltip" data-placement="bottom" title="Height (cm)" />' +
      '</div>' +
      '</div>' +
      '</div>';
    ...
    html_code += '<div class="col-sm-12 col-md-1">' +
      ...
      '<div class="input-group">' +
      '<input type="text" readonly value="0" onkeypress="return cdp_soloNumeros(event)"  name="weightVol" id="weightVol_' + index + '" class="form-control input-sm number_only" data-toggle="tooltip" data-placement="bottom" title="Vol. Weight" />' +
      '</div>' +
      '</div>' +
      '</div>';

    // html_code += '<div class="col-sm-12 col-md-1" style="display:none;">' +
    //   '<div class="form-group">' +
    //   '<label for="emailAddress1">F. charge</label> ' +
    //   '<div class="input-group">' +
    //   '<input type="text" onchange="changePackage(this)" value="' + item.fixed_value + '" onkeypress="return cdp_soloNumeros(event)"  name="fixed_value" id="fixedValue_' + index + '" class="form-control input-sm number_only" data-toggle="tooltip" data-placement="bottom" title="Fixed charge"/>' +
    //   '</div>' +
    //   '</div>' +
    //   '</div>';
    ...
    html_code += '<div class="col-sm-12 col-md-1">' +
      ...
      '<div class="input-group">' +
      '<input type="text" onchange="changePackage(this)" value="' + item.declared_value + '" onkeypress="return cdp_soloNumeros(event)"  name="declared_value" id="declaredValue_' + index + '" class="form-control input-sm number_only" data-toggle="tooltip" data-placement="bottom" title="Declared value"/>' +
      '</div>' +
      '</div>' +
      '</div>';
